...
const createDetailRows = (values = {}) => [
  ...
  },
  {
    key: "work",
    label: "Work",
    placeholder: "e.g. Kashmiri Ari Work",
  },
  {
    key: "pattern",
    label: "Pattern",
    placeholder: "e.g. Floral & Traditional",
  },
  {
    key: "neckType",
    label: "Neck Type",
  ...
  },
  {
    key: "occasion",
    label: "Occasion",
    placeholder: "e.g. Casual & Festive Wear",
  },
  {
    key: "length",
    label: "Length",
...
export default function AddProduct() {
  ...
  const loadProduct = async () => {
    try {
      ...
      setCareInstructions(
        Array.isArray(details.careInstructions) &&
          details.careInstructions.length
          ? details.careInstructions
          : emptyCareInstructions()
      );

      setDeliveryServices(
        Array.isArray(details.deliveryServices) &&
          details.deliveryServices.length
  ...
  const addColorVariant = () => {
    setColorVariants((prev) => [...prev, createColor()]);
  };
  ...
  const removeNewColorImage = (colorIndex, imageIndex) => {
    setColorVariants((prev) =>
      prev.map((item, i) => {
        ...
        if (item.previews[imageIndex]) {
          URL.revokeObjectURL(item.previews[imageIndex]);
        }
  ...
  const removeExistingColorImage = async (
    colorIndex,
    image
  ) => {
    ...
    <div className="container-fluid souk-admin-product">
      <div className="souk-admin-product-heading">
        <div>
          ...
          <p>
            Create the product content exactly
      ...
      >
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                className="form-control"
                {...register("brand")}
                placeholder="e.g. SOUK – The House of Fashion"
              />
            </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              ...
              <select
                ...
                {...register("discount")}
              >
                {[0, 5, 10, 15, 20, 25, 30, 40, 50, 60, 70, 80].map(
                  (value) => (
                    <option
                      key={value}
                      value={value}
        ...
        <section className="souk-admin-form-section">
          ...
          <textarea
            ...
            placeholder="Describe the product, craftsmanship, styling and intended use..."
          />
        </section>
        ...
        <section className="souk-admin-form-section">
          <div className="souk-admin-section-heading">
            <div>
              ...
              <div>
                ...
                <p>
                  Enter the actual product
                  information. The text shown
                  inside empty fields is only an
                  example.
                </p>
              </div>
            </div>
          ...
          <div className="souk-admin-note-field">
            ...
            <textarea
              ...
              placeholder="e.g. Slight colour variation may occur due to lighting."
            />
          </div>
        </section>
          ...
          <div className="souk-admin-section-heading">
            <div>
              ...
              <div>
                ...
                <p>
                  Each item becomes a bullet
                  point under Care Instructions.
                </p>
              </div>
            </div>
              ...
              (item, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="form-control"
                    value={item}
                    placeholder="e.g. Gentle hand wash recommended"
                    onChange={(event) =>
                      updateListItem(
                        setCareInstructions,
                        index,
          ...
          <div className="souk-admin-section-heading">
            <div>
              ...
              <div>
                ...
                <p>
                  Each item becomes a bullet
                  point in the delivery/services
                  section.
                </p>
              </div>
            </div>
              ...
              (item, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="form-control"
                    value={item}
                    placeholder="e.g. Pan-India Delivery Available"
                    onChange={(event) =>
                      updateListItem(
                        setDeliveryServices,
                        index,
        ...
        <section className="souk-admin-form-section">
          <div className="souk-admin-section-heading">
            <div>
              ...
              <div>
                ...
                <p>
                  Keep colour-specific
                  galleries connected to the
                  existing product image system.
                </p>
              </div>
            </div>
          ...
          {colorVariants.map(
            (variant, colorIndex) => (
              <div
                className="souk-admin-color-card"
                key={colorIndex}
              >
                ...
                <div className="souk-admin-image-grid">
                  {variant.existingImages.map(
                    (image) => (
                      <div
                        className="souk-admin-image-item"
                        key={image.public_id}
                      >
                        <img
                          src={image.url}
          ...
          {colorVariants.length === 0 && (
            <div className="souk-admin-empty-colors">
              No colour variants added. Add a
              colour when you want selectable
              colour swatches and
